...
public class ToastMsg {
    ...
    public void toastIconInfo(String s) {
        Toast toast = new Toast(context);
        toast.setDuration(Toast.LENGTH_LONG);
        ...
        View custom_view = inflater.inflate(R.layout.toast_icon_text, null);
        ((TextView) custom_view.findViewById(R.id.message)).setText(s);
        ((ImageView) custom_view.findViewById(R.id.icon)).setImageResource(R.drawable.ic_info_black);
        ((CardView) custom_view.findViewById(R.id.parent_view)).setCardBackgroundColor(context.getResources().getColor(R.color.blue_400));
