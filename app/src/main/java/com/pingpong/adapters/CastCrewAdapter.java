...
import com.pingpong.utils.ItemAnimation;
...
public class CastCrewAdapter extends RecyclerView.Adapter<CastCrewAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if (castCrew != null) {
            ...
            GlideApp.with(context).load(castCrew.getImageUrl())
                    //.override(200,200)
                    .error(R.drawable.background_drawable)
                    .placeholder(R.drawable.background_drawable).into(holder.castIv);
            //Picasso.get().load(castCrew.getImageUrl()).error(R.drawable.round_bg).placeholder(R.drawable.round_bg).into(holder.castIv);
