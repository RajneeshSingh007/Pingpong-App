    ...
    public void onBindViewHolder(final NavigationAdapter.OriginalViewHolder holder, final int position) {
        ...
        if (position==0){
            ...
            if (menuStyle.equals("grid")) {
                ...
                holder.image.setImageTintList(ColorStateList.valueOf(ContextCompat.getColor(ctx, R.color.colorPrimary)));
            } else {
...
//        holder.image.setImageResource(obj.getImg());
        ...
        holder.image.setImageTintList(ColorStateList.valueOf(ContextCompat.getColor(ctx, R.color.white)));
        if (menuStyle.equals("grid")) {
